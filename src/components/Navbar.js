            ...
            {navbarActive &&
                (
                    <div className="md:hidden h-screen flex flex-col p-8 bg-primary w-[100%] gap-6 font-semibold text-secondary bg-primary overflow-hidden bg-gradient-to-l from-primary to-fade">
                        <Link onClick={handleMobileNavbarApply} to = "AboutMe" smooth = {true} duration={500} className="p-2 hover:border-b-2 hover:border-solid hover:border-complementary  hover:cursor-pointer hover:justify-start hover:flex text-lg">About</Link>
                        <Link onClick={handleMobileNavbarApply} to = "Skills" smooth = {true} duration = {500} className="p-2  hover:border-b-2 hover:border-solid hover:border-complementary hover:cursor-pointer hover:justify-start hover:flex text-lg">Skills</Link>
                        <Link onClick={handleMobileNavbarApply} to = "Projects" smooth = {true} duration={500} className="p-2 hover:border-b-2 hover:border-solid hover:border-complementary  hover:cursor-pointer hover:justify-start hover:flex text-lg">Projects</Link>
                        <Link onClick={handleMobileNavbarApply} to="Contact" smooth = {true} duration={500} className=" justify-center items-center flex rounded-md bg-complementary p-3 px-6 hover:scale-110 w-fit duration-500 hover:cursor-pointer text-primary font-semibold text-lg">Contact Me</Link>
                    </div>
                )}
        </nav>
    )
