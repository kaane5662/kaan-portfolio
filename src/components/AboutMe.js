...
export default function AboutMe(){
    return(
        <div name = "AboutMe" className="  flex flex-col justify-center items-center px-28 max-md:px-4 text-secondary h-screen font-montserrat">
            ...
            viewport={{ once: false }}
            className="my-12 max-md:my-4  flex flex-col max-md:gap-3  gap-10 justify-center items-center px-24 max-md:px-0">
                <h1 className="text-4xl font-semibold text-center px-32 max-md:px-0 max-md:text-xl">Hi, I'm <span className=" text-complementary">Kaan</span>, nice to meet you. Please take a look around.</h1>
                <p className="text-md text-center max-md:text-xs">
